    ...
    <div className="min-h-screen qr-pattern">
      ...
      <div className="max-w-lg mx-auto px-4 py-10 space-y-5">
        ...
        <div className="bg-white border border-border rounded-2xl p-6 space-y-4">
          ...
          <Button
            size="lg"
            className="w-full flex items-center justify-center gap-3 bg-gray-900 hover:bg-gray-800 text-white rounded-xl"
          ...
          <Button
            size="lg"
            className="w-full flex items-center justify-center gap-3 bg-violet-600 hover:bg-violet-700 text-white rounded-xl"
            ...
            <div className="space-y-2">
              {status.recentClaims.map((cl, i) => (
                <div key={i} className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-mono font-semibold text-primary text-sm">{formatUsdc(cl.amount)}</span>
                </div>
              ))}
            </div>
          </div>
